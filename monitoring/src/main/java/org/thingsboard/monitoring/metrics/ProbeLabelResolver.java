...
// Shared by ProbeMetricsRecorder (OTLP/Prometheus gauges) and ProbeEventLogger (raw OpenSearch
// events) so the two channels can never disagree on how a check/endpoint label is derived.
@Slf4j
public final class ProbeLabelResolver {
    ...
    public static String tryResolveEndpoint(String configKey, String baseUrl, String probeName,
        ...
        try {
            ...
            // an invalid base URL must not fail the whole application context just because metrics/event
            // export is enabled - the caller treats a null return as "skip this probe specifically"
